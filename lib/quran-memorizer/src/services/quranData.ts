...
export const MUTASHABIHAT_SAMPLE: MutashabihItem[] = [
  {
    ...
    similarityNote: 'Order of شَفَاعَةٌ and عَدْلٌ is swapped between Ayah 48 (Shafa\'ah first) and Ayah 123 (\'Adl first).'
  },
  {
    id: 'm2',
    surahNumber: 2,
    ...
    similarityNote: 'Baqarah uses "ادْخُلُوا" and "رَغَدًا", whereas A\'raf uses "اسْكُنُوا" without "رَغَدًا".'
  },
  {
    id: 'm3',
    surahNumber: 3,
    ...
    similarityNote: 'Aal-E-Imran uses "وَسَارِعُوا" and "عَرْضُهَا", Hadid uses "سَابِقُوا" and "كَعَرْضِ السَّمَاءِ".'
  }
];
