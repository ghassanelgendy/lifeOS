...
let package = Package(
    ...
    dependencies: [
        ...
        .package(name: "CapacitorDialog", path: "../../../node_modules/.pnpm/@capacitor+dialog@8.0.1_@capacitor+core@8.5.1/node_modules/@capacitor/dialog"),
        ...
        .package(name: "CapawesomeCapacitorBadge", path: "../../../node_modules/.pnpm/@capawesome+capacitor-badge@8.0.3_@capacitor+core@8.5.1/node_modules/@capawesome/capacitor-badge"),
        .package(name: "CapgoCapacitorUpdater", path: "../../../node_modules/.pnpm/@capgo+capacitor-updater@8.51.15_@capacitor+core@8.5.1/node_modules/@capgo/capacitor-updater")
    ],
    targets: [
        .target(
            name: "CapApp-SPM",
