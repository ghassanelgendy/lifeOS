      ...
      {isLoading ? (
        ...
        sleepOrder.filter(visible).map((sectionId) => {
          ...
          if (sectionId === 'timeline') {
            return (
              <div key="timeline" className="rounded-xl border border-border/50 bg-card p-6">
            ...
            return (
              <div key="sessions" className="rounded-xl border border-border bg-card p-4 md:p-6">
                <div className="flex items-center justify-between mb-4">
                  ...
                  <TabList
                    selectedValue={sessionLimit}
                    onTabSelect={(_e, data) => setSessionLimit(data.value as 7 | 30)}
                    appearance="subtle"
                    size="small"
